...
//JS Homepage
var home_class = $('#home-style').val();
var hero_class = $('#hero-style').val();
$('body').addClass(home_class);
$('body').addClass(hero_class);
...
$(document).ready(function() {
    ...
    function cpNav() {
        ...
        $("#app-header .main-nav .block-menu > ul").clone().appendTo(cpContainer); // clone the main nav into the cp nav container
...
$(window).load(function(){
    ...
    $('#cp-trigger').click(function() {
        toggleCP();
        $('body .cp-nav-container .main-search input[type=text]').attr('placeholder', 'Enter your query...');
    });
...
$(document).ready(function() {
    ...
    function flyoutNav() {
        ...
        $("#app-header .main-nav .block-menu > ul").clone().appendTo(fnContainer); // clone the main nav into the flyout nav container
