...
if($.cookie("nexuse-color")) {
    $("link.color-switcher").attr("href",$.cookie("nexuse-color"));
}
...
$(document).ready(function() { 
    ...
    $(".theme-options .theme-color").click(function() { 
        ...
        $.cookie("nexuse-color",$(this).attr('href'), {expires: 365, path: '/'});
        return false;
    });
    ...
    if (identifier === "#app-green") {
        ...
        $.cookie("nexuse-color","assets/styles/css/app-green.css", {expires: 365, path: '/'});
    } else if (identifier === "#app-pink") {
        $("link.color-switcher").attr("href","assets/styles/css/app-pink.css");
        $.cookie("nexuse-color","assets/styles/css/app-pink.css", {expires: 365, path: '/'});
    }  else if (identifier === "#app-red") {
        $("link.color-switcher").attr("href","assets/styles/css/app-red.css");
        $.cookie("nexuse-color","assets/styles/css/app-red.css", {expires: 365, path: '/'});
    }  else if (identifier === "#app-blue") {
        $("link.color-switcher").attr("href","assets/styles/css/app.css");
        $.cookie("nexuse-color","assets/styles/css/app.css", {expires: 365, path: '/'});
    } 
